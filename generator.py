x: list[str] = ['a','b','c']
z= (y for y in x if y != 'a') # looks like a list comprehension but it's a generator expression. This produces a generator object
for c in z:
    print(c)
...
j = 'k'.join(y for y in x if y != 'a') # can use join on a generator which will act like a list
print(j)