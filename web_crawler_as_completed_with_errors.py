    ...
    def getUrls(self, url: str) -> List[str]:
        ...
        try:
            if url == "http://news.yahoo.com":
                ...
                result['urls'] = ["http://news.yahoo.com", "http://news.google.com","http://news.yahoo.com/2000"]
            elif url == "http://news.yahoo.com/2000":
                result['urls'] = ["http://news.yahoo.com", "http://news.google.com","http://news.yahoo.com/20000"]
            elif url == "http://news.yahoo.com/200000":
                result['urls'] = ["http://news.yahoo.com", "http://news.google.com","http://news.yahoo.com/2000000"]
            else:
        ...
        with ThreadPoolExecutor(max_workers=100) as executor:
            ...
            while futures:
                ...
                for future in as_completed(futures): # whenever a future is finished, it will loop, future being the one that is finished
                    ...
                    futures = [future for future_in_stack in futures if future_in_stack is not future]
